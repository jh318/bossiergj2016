...
public class EnemySpawnerController : MonoBehaviour {
	...
	public float framerate = 360.0f; // Needs to be multiples of 6 or 60
	//create variable to hold enemy GameObject
	...
	void Update () {
		...
		if (Time.frameCount%framerate == 0){ //check if total frame count is divisiable by 360 frames IE every 6 seconds, spawn enemy
